...
# 17- fixed error with inf in the matrix- just removed and then skip because too short for AI calculations
...
fbinMax    = 9 #sets the frequency bins to looks across for cluster analysis- relates to frequency bins in biological band
Outdir = "F:\\RESEARCH\\NSNSD_EclipseSoundScape\\AcousticIndex" #where to put the site files with acoustic indices
startday =  "2017_08_18"
